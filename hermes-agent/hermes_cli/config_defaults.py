...
DEFAULT_CONFIG = {
    ...
    "delegation": {
        ...
        # Named subagent identities (personas). Each entry: {name, system_prompt}.
        # The orchestrator passes `identity: "<name>"` to delegate_task to use one;
        # its system_prompt replaces the generic "focused subagent" opener. Empty
        # list = all subagents use the default identity.
        "identities": [],
    },
