...
const renderEmptyBreadcrumb = () => {
    ...
    return (
      <div className="flex items-center gap-1.5 mb-3 text-[calc(var(--helix-transcript-size)*0.8571)] text-foreground/60">
        ...
        <span className="max-w-[200px] truncate">{projectName.length > 14 ? projectName.slice(0, 14) + '…' : projectName}</span>
      </div>
    )
  }
                ...
                <div className="flex items-center gap-1.5 mb-3 justify-start">
                  <div className="relative" ref={folderDropdownRef}>
                    ...
                    >
                      ...
                      <span className="max-w-[160px] truncate">{selectedWorkDir ? (selectedWorkDir.split(/[\\/\\]/).pop() || selectedWorkDir) : '选择项目'}</span>
