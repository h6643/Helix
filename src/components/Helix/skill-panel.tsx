...
import { X, Search, Trash2, ToggleLeft, ToggleRight, Plus } from "lucide-react";
  ...
  const loadPlugins = async () => {
    ...
    try {
      ...
      if (Array.isArray(res?.plugins)) {
        ...
        setPlugins(
          res.plugins.filter((p: BackendPlugin) => {
      ...
      <div className="flex items-center justify-between px-6 py-4 shrink-0">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            data-tip={
              activeTab === "plugins" ? "插件需通过配置添加" : "打开技能目录"
            }
          >
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      <button
                        ...
                        data-tip={
                          plugin.status === "enabled" ? "点击禁用" : "点击启用"
                        }
                      >
                        {plugin.status === "enabled" ? (
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`text-[calc(var(--helix-transcript-size)*0.7143)] px-1.5 py-0.5 rounded font-medium ${
                            skill.isBuiltin
