      ...
      <div className="flex-1 overflow-auto p-3 space-y-4">
        ...
        <section>
          ...
          {loading ? (
            ...
            <div className="flex items-center justify-center h-24 text-destructive text-[length:var(--helix-transcript-size)]">
              {error}
            </div>
            ...
            <div className="flex flex-col items-center justify-center h-32 text-muted-foreground text-[length:var(--helix-transcript-size)]">
              ...
              <p>暂无子 agent 记录</p>
              <p className="text-[calc(var(--helix-transcript-size)*0.8571)] mt-1">
                使用 delegate_task 时会在这里显示
              </p>
            </div>
