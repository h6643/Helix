...
const THEMES: Record<string, HelixThemeDef> = {
  ...
  'ctp-everforest-light': { id: 'ctp-everforest-light', label: 'Everforest 淡桃', mode: 'light', ctp: everforestLight, pair: 'ctp-everforest-dark' },
  ...
  'ctp-notion-light': { id: 'ctp-notion-light', label: 'Notion 红棕', mode: 'light', ctp: notionLight, pair: 'ctp-notion-dark' },
  ...
  'ctp-kanagawa-dark': { id: 'ctp-kanagawa-dark', label: 'Kanagawa 浅橙', mode: 'dark', ctp: kanagawaDark },
  ...
  'ctp-royal-velvet': { id: 'ctp-royal-velvet', label: 'Royal Velvet 浅桃', mode: 'dark', ctp: royalVelvetDark },
...
export const THEME_SELECT_GROUPS: { label: string; options: { value: string; label: string }[] }[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'ctp-everforest-light', label: 'Everforest 淡桃' },
      ...
      { value: 'ctp-notion-light', label: 'Notion 红棕' },
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'ctp-kanagawa-dark', label: 'Kanagawa 浅橙' },
      ...
      { value: 'ctp-royal-velvet', label: 'Royal Velvet 浅桃' },
