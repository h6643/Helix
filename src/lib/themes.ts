...
const gruvboxLight: CtpPalette = P({
  rosewater: "243, 128, 25",
  flamingo: "207, 162, 174",
  pink: "177, 98, 118",
  mauve: "177, 98, 134",
  red: "204, 36, 29",
  maroon: "204, 49, 29",
  ...
  sapphire: "26, 133, 152",
  blue: "69, 133, 136",
  lavender: "146, 111, 175",
  text: "40, 40, 40",
  subtext1: "80, 73, 69",
  subtext0: "102, 92, 84",
  overlay2: "149, 131, 106",
  overlay1: "168, 153, 133",
  overlay0: "189, 174, 147",
  surface2: "214, 196, 161",
  surface1: "235, 219, 179",
  surface0: "242, 229, 188",
  base: "249, 245, 215",
  mantle: "236, 225, 196",
  crust: "230, 215, 178",
});
...
const luminescenceLight: CtpPalette = P({
  rosewater: "227, 130, 130",
  flamingo: "227, 130, 154",
  pink: "237, 172, 171",
  mauve: "212, 165, 198",
  red: "232, 152, 151",
  maroon: "209, 149, 148",
  ...
  teal: "98, 157, 142",
  sky: "98, 157, 157",
  sapphire: "117, 153, 189",
  blue: "130, 146, 201",
  lavender: "151, 151, 211",
  text: "101, 73, 65",
  subtext1: "122, 91, 82",
  subtext0: "122, 91, 82",
  overlay2: "157, 130, 123",
  overlay1: "194, 171, 163",
  overlay0: "223, 219, 200",
  surface2: "246, 243, 239",
  surface1: "225, 212, 208",
  surface0: "205, 183, 177",
  base: "242, 238, 232",
  mantle: "236, 231, 223",
  crust: "236, 231, 223",
});
...
const nordLight: CtpPalette = P({
  rosewater: "209, 135, 112",
  flamingo: "180, 142, 173",
  pink: "180, 142, 173",
  mauve: "180, 142, 173",
  red: "191, 97, 106",
  maroon: "191, 97, 106",
  ...
  overlay2: "76, 86, 106",
  overlay1: "86, 97, 118",
  overlay0: "143, 188, 187",
  surface2: "216, 222, 233",
  surface1: "216, 222, 233",
  surface0: "229, 233, 240",
  base: "236, 239, 244",
  mantle: "231, 235, 241",
  crust: "229, 233, 240",
});
...
const notionLight: CtpPalette = P({
  ...
  subtext1: "77, 74, 66",
  subtext0: "99, 95, 84",
  overlay2: "121, 117, 103",
  overlay1: "123, 135, 142",
  overlay0: "145, 155, 161",
  surface2: "170, 177, 182",
  surface1: "189, 195, 199",
  surface0: "208, 212, 215",
  base: "255, 255, 255",
  mantle: "244, 245, 246",
  crust: "227, 230, 232",
});
...
const sandyBeachesLight: CtpPalette = P({
  rosewater: "228, 212, 196",
  flamingo: "214, 188, 174",
  pink: "200, 164, 152",
  mauve: "149, 136, 138",
  red: "166, 137, 123",
  maroon: "186, 144, 123",
  ...
  teal: "149, 156, 153",
  sky: "138, 155, 163",
  sapphire: "124, 133, 143",
  blue: "109, 111, 123",
  lavender: "135, 128, 142",
  text: "104, 88, 80",
  subtext1: "108, 92, 84",
  subtext0: "111, 96, 88",
  overlay2: "118, 103, 96",
  overlay1: "124, 110, 103",
  overlay0: "130, 117, 110",
  surface2: "205, 197, 193",
  surface1: "212, 205, 200",
  surface0: "222, 216, 209",
  base: "240, 234, 226",
  mantle: "237, 231, 224",
  crust: "230, 223, 216",
});
...
const atomDark: CtpPalette = P({
  rosewater: "226, 196, 168",
  flamingo: "238, 187, 216",
  pink: "221, 120, 211",
  mauve: "198, 120, 221",
  red: "224, 108, 117",
  maroon: "224, 121, 108",
  ...
  sapphire: "93, 185, 187",
  blue: "97, 175, 239",
  lavender: "170, 127, 183",
  text: "221, 222, 223",
  subtext1: "171, 171, 171",
  subtext0: "135, 135, 135",
  overlay2: "108, 115, 132",
  overlay1: "96, 102, 118",
  overlay0: "80, 85, 98",
  surface2: "66, 73, 88",
  surface1: "57, 63, 76",
...
const coffeeDark: CtpPalette = P({
  rosewater: "236, 222, 213",
  flamingo: "234, 195, 214",
  pink: "234, 159, 194",
  mauve: "215, 159, 234",
  red: "234, 159, 159",
  maroon: "234, 169, 159",
  ...
  teal: "164, 234, 192",
  sky: "174, 224, 206",
  sapphire: "163, 225, 235",
  blue: "163, 200, 235",
  lavender: "182, 186, 226",
  text: "250, 218, 195",
  subtext1: "247, 204, 172",
  subtext0: "235, 192, 160",
  overlay2: "199, 163, 136",
  overlay1: "173, 144, 124",
  overlay0: "120, 102, 96",
  surface2: "94, 84, 86",
  surface1: "85, 77, 82",
  surface0: "76, 70, 78",
...
const kanagawaDark: CtpPalette = P({
  rosewater: "255, 200, 148",
  flamingo: "210, 126, 129",
  pink: "210, 126, 153",
  mauve: "149, 127, 184",
  red: "255, 93, 98",
  maroon: "228, 104, 118",
  ...
  teal: "122, 168, 159",
  sky: "163, 212, 213",
  sapphire: "127, 180, 202",
  blue: "126, 156, 216",
  lavender: "147, 138, 169",
  text: "220, 215, 186",
  subtext1: "212, 206, 170",
  subtext0: "200, 192, 147",
  overlay2: "95, 95, 124",
  overlay1: "84, 84, 109",
  overlay0: "73, 73, 95",
  surface2: "62, 62, 81",
...
const nordDark: CtpPalette = P({
  rosewater: "226, 191, 169",
  flamingo: "239, 171, 150",
  pink: "214, 163, 222",
  mauve: "180, 142, 173",
  red: "191, 97, 106",
  maroon: "191, 108, 97",
  ...
  blue: "94, 129, 172",
  lavender: "192, 167, 187",
  text: "236, 239, 244",
  subtext1: "229, 233, 240",
  subtext0: "217, 222, 232",
  overlay2: "196, 201, 212",
  overlay1: "172, 180, 195",
  overlay0: "149, 158, 178",
  surface2: "125, 137, 161",
  surface1: "103, 116, 142",
  surface0: "77, 87, 106",
  base: "67, 76, 94",
  mantle: "59, 66, 82",
  crust: "46, 52, 64",
...
const notionDark: CtpPalette = P({
  rosewater: "246, 174, 138",
  flamingo: "248, 160, 154",
  pink: "226, 85, 161",
  mauve: "154, 109, 215",
  red: "255, 115, 105",
  maroon: "255, 120, 105",
  ...
  sapphire: "82, 178, 202",
  blue: "82, 156, 202",
  lavender: "156, 125, 198",
  text: "227, 230, 232",
  subtext1: "222, 225, 227",
  subtext0: "200, 205, 208",
  overlay2: "178, 185, 189",
  overlay1: "156, 165, 171",
  overlay0: "134, 145, 152",
  surface2: "113, 125, 132",
  surface1: "94, 104, 110",
  surface0: "75, 83, 88",
  base: "61, 68, 72",
  mantle: "54, 60, 63",
...
const THEMES: Record<string, HelixThemeDef> = {
  ...
  "ctp-gruvbox-light": {
    id: "ctp-gruvbox-light",
    label: "Gruvbox 棕橙",
    mode: "light",
    ctp: gruvboxLight,
  },
  "ctp-luminescence-light": {
    id: "ctp-luminescence-light",
    label: "Luminescence 桃花",
    mode: "light",
    ctp: luminescenceLight,
  },
  "ctp-nord-light": {
    id: "ctp-nord-light",
    label: "Nord 蓝雪",
  ...
  "ctp-notion-light": {
    ...
    mode: "light",
    ctp: notionLight,
    pair: "ctp-notion-dark",
  },
  "ctp-sandy-beaches-light": {
    id: "ctp-sandy-beaches-light",
    label: "Sandy Beaches 沙滩",
    mode: "light",
    ctp: sandyBeachesLight,
  },
  "ctp-solarized-light": {
