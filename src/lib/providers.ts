...
const PROVIDERS: ProviderConfig[] = [
  ...
  },
  {
    ...
    models: ["meta-llama/llama-3.1-405b-instruct", "deepseek/deepseek-r1"],
  ...
  },
  {
    ...
    models: ["jamba-1.5-large", "jamba-1.5-mini", "jamba-mini"],
    envKey: "AI21_API_KEY",
  ...
  },
  {
    ...
    models: ["trinity-mini", "trinity-large"],
    envKey: "ARCEEAI_API_KEY",
    website: "https://chat.arcee.ai",
  },
  // ── Cloud platforms ──────────────────────────────────────────────────────
  {
    id: "azure",
  ...
  },
  {
    ...
    models: ["gmi-default"],
    envKey: "GMI_API_KEY",
    website: "https://gmi.cloud",
  },
  {
    id: "azure-foundry",
    name: "Azure Foundry",
    baseUrl: "https://YOUR_RESOURCE.services.ai.azure.com/models",
    models: ["gpt-4o", "Phi-4"],
  ...
  // ── Agnes / Helix ───────────────────────────────────────────────────────
  {
    ...
    models: ["helix-3-llama-3.1-405b", "helix-3-llama-3.1-70b"],
    envKey: "NOUS_API_KEY",
  ...
  },
  {
    ...
    models: ["MiniMax-Text-01", "abab6.5s-chat", "abab6.5t-chat"],
