...
export function getToolIcon(toolName: string) {
  ...
  if (name.includes("read") || name.includes("view"))
    return <Eye className="size-[0.9em]" />;
  if (name.includes("write") || name.includes("create"))
    return <Pencil className="size-[0.9em]" />;
  if (name.includes("edit") || name.includes("modify"))
    return <Pencil className="size-[0.9em]" />;
  if (name.includes("grep") || name.includes("search"))
    return <Search className="size-[0.9em]" />;
  if (
    name.includes("bash") ||
    name.includes("shell") ||
    name.includes("terminal")
  )
    return <Terminal className="size-[0.9em]" />;
  if (name.includes("glob") || name.includes("list"))
    return <FolderOpen className="size-[0.9em]" />;
